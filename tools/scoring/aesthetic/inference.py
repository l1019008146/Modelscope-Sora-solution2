...
class AestheticScorer(nn.Module):
    def __init__(self, input_size, device):
        ...
        # self.clip, self.preprocess = clip.load("/data/txh/Open-Sora/tools/caption/clip-vit-large-patch14-336", device=device)
...
def main():
    ...
    model.mlp.load_state_dict(torch.load("./tools/scoring/aesthetic/pretrained_models/aesthetic.pth", map_location=device))
